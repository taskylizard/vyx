...
import type { Client as RevoltClient } from 'revolt.js';
import type { Mapping, PartialDiscordMessage, ReplyObject } from './interfaces';
...
function formatMessage(
  ...
  if (emojis) {
    emojis.forEach((emoji, idx) => {
      ...
      if (dissected !== null && dissected.groups !== undefined) {
...
export async function handleDiscordMessage(
  ...
  try {
    ...
    if (
      ...
      const stickerUrl = sticker && sticker.url;
